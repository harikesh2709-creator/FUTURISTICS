"""
FUTURISTICS - Smart India Hackathon (SIH 2026) Official Presentation Deck
Project: SPECTRA - Automated Analysis of .IQ and .wav Files along with Signal Parameter Extraction
Problem Statement: NTRO-PS-26147 / SIH2026-SEC-01
Team Name: FUTURISTICS | Team ID: SIH-2026

Fully packed layout matching reference winning SIH presentation:
- Large, bold, highly readable typography (titles 20-28pt, ribbons 10-10.5pt, lead bullets 9.5-10pt, body 8.5-9.2pt)
- Crystal-clear, ultra-sharp, high-DPI cropped images of real Signal Analyzer outputs
- Zero wasted space, beautiful dark-navy and glassmorphism styling
"""
...
# -------------------------------------------------------------
# SLIDE 3: TECHNICAL APPROACH & ARCHITECTURE (MATCHING PDF PAGE 3)
# -------------------------------------------------------------
...
def build_slide_8(prs):
    ...
    for role_badge, member_name, title, domain, col, x in members:
        ...
        tb = slide.shapes.add_textbox(Inches(x+0.05), Inches(4.92), Inches(1.78), Inches(1.55))
        tf = tb.text_frame
        tf.word_wrap = True
        p1 = tf.paragraphs[0]
        p1.text = member_name
...
def main():
    ...
    out_file = "SPECTRA_SIH_2026_Presentation.pptx"
    prs.save(out_file)
