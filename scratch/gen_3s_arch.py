...
out_path = os.path.join(assets_dir, 'system_architecture_3s.png')
...
# Title
ax.text(5.5, 4.2, "SPECTRA 3S SYSTEM ARCHITECTURE & DATA FLOW", 
        fontsize=13, fontweight='bold', color=c_cyan, ha='center', va='center', family='sans-serif')
ax.text(5.5, 3.85, "1. STRUCTURED INGESTION  ──►  2. SMART AI & DSP INFERENCE  ──►  3. SOVEREIGN C4ISR ACTION",
...
s1_items = [
    ...
    "• High-rate .wav audio files",
    "• SDR Streams (HackRF / USRP)",
    "• Automated DC Offset Nulling",
    "• Polyphase Channelizer Filter",
    "• IQ Phase & Gain Imbalance Balancing"
]
...
s3_items = [
    "• Decoded Bitstream Hex",
    "• Viterbi Trellis Payload Bits",
    "• WebGL Interactive Canvas",
    "• SHA-256 Audit Dossier",
    "• Emitter Radar Threat Score",
...
plt.close()
print(f"Generated 3S architecture image at: {out_path}")
