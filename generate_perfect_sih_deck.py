"""
Build Official SIH 2026 Perfect Presentation Deck matching the video's layout.
"""
...
OUT_PPTX_7 = os.path.join(OUT_DIR, "SIH2026_FreightForecast_Pro_Perfect.pptx")
OUT_PPTX_6 = os.path.join(OUT_DIR, "SIH2026_FreightForecast_Pro_Perfect_6Slides.pptx")
OUT_PDF_6 = os.path.join(OUT_DIR, "SIH2026_FreightForecast_Pro_Perfect_6Slides.pdf")
OUT_PDF_7 = os.path.join(OUT_DIR, "SIH2026_FreightForecast_Pro_Perfect.pdf")
